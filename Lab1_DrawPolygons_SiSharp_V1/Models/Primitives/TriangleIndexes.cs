...
namespace DrawPolygons.Models.Primitives
{
    public class TriangleIndexes
    {
        ...
        public TriangleIndexes(int[] verticesGeometricIndexes, int[] verticesTextureIndexes, int[] vectorsNormalIndexes)
        {
            if (verticesGeometricIndexes.Length == COUNT_VERTICES && verticesTextureIndexes.Length == COUNT_VERTICES && vectorsNormalIndexes.Length == COUNT_VERTICES)
            {
